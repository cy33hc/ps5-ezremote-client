...
## Installation
Extracted the **ezremote_client.zip** in to the **/data/homebrew** folder on the PS5. Launch app with @john-tornblom [Homebrew Launcher](https://github.com/ps5-payload-dev/websrv).
